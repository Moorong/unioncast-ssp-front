...
public class SspPlanTargetConditionServiceImpl
    ...
    @Override
    public RestResponse update(SspPlanTargetCondition sspPlanTargetCondition) {
        HttpEntity<SspPlanTargetCondition> httpEntity = new MyHttpEntity<SspPlanTargetCondition>(
                sspPlanTargetCondition);
        RestResponse restResponse = restTemplate.postForObjectForDB("/rest/ssp/planTargetCondition/update",
                httpEntity, RestResponse.class);
        return restResponse;
    }
