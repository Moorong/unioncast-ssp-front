...
public class RestUtil {
	...
	public static <T> T postForObjectForRep(String methodUrl, Object request, Class<T> restResponseClass) {
		String url = String.format("%s%s", SpringUtils.getConfig().getRestReport(), methodUrl);
		return postForObject(url,request,restResponseClass);
	}
